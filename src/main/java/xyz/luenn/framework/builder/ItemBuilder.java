package xyz.luenn.framework.builder;
...
import xyz.luenn.framework.MarpleFrameWork;
...
public class ItemBuilder {
    ...
    public ItemBuilder setNBT(String key, String value) {
        itemMeta.getPersistentDataContainer().set(new NamespacedKey(JavaPlugin.getProvidingPlugin(MarpleFrameWork.class), key), PersistentDataType.STRING, value);
        return this;
    }
    ...
    public ItemBuilder removeNBT(String key) {
        itemMeta.getPersistentDataContainer().remove(new NamespacedKey(JavaPlugin.getProvidingPlugin(MarpleFrameWork.class), key));
        return this;
    }
